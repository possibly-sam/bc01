...
# Business Case descriptions least associated with Principal Component #2
...
# Business Case descriptions most associated with Principal Component #18

## ID `r ff[[18]]$get_most_like_idx(1)` Value = `r ff[[18]]$get_most_like_value(1)`
`r ff[[18]]$get_most_like_text(1)`

## ID `r ff[[18]]$get_most_like_idx(2)`  Value = `r ff[[18]]$get_most_like_value(2)`
`r ff[[18]]$get_most_like_text(2)`

## ID `r ff[[18]]$get_most_like_idx(3)`  Value = `r ff[[18]]$get_most_like_value(3)`
`r ff[[18]]$get_most_like_text(3)`

## ID `r ff[[18]]$get_most_like_idx(4)`  Value = `r ff[[18]]$get_most_like_value(4)`
`r ff[[18]]$get_most_like_text(4)`

## ID `r ff[[18]]$get_most_like_idx(5)`  Value = `r ff[[18]]$get_most_like_value(5)`
`r ff[[18]]$get_most_like_text(5)`


# Business Case descriptions least associated with Principal Component #18

## ID `r ff[[18]]$get_least_like_idx(1)`  Value = `r ff[[18]]$get_least_like_value(1)`
`r ff[[18]]$get_least_like_text(1)`

## ID `r ff[[18]]$get_least_like_idx(2)`  Value = `r ff[[18]]$get_least_like_value(2)`
`r ff[[18]]$get_least_like_text(2)`

## ID `r ff[[18]]$get_least_like_idx(3)`  Value = `r ff[[18]]$get_least_like_value(3)`
`r ff[[18]]$get_least_like_text(3)`

## ID `r ff[[18]]$get_least_like_idx(4)`  Value = `r ff[[18]]$get_least_like_value(4)`
`r ff[[18]]$get_least_like_text(4)`

## ID `r ff[[18]]$get_least_like_idx(5)`  Value = `r ff[[18]]$get_least_like_value(5)`
`r ff[[18]]$get_least_like_text(5)`
